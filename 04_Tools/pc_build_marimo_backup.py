...
def _():
    builds = {
        "Ukraine-first core + HU case": {
            "CPU": "CPU_01_UA",
            "Main board": "MB_01_UA",
            "Memory": "RAM_01_UA",
            "Storage": "SSD_01_UA",
            "Power supply": "PSU_01_UA",
            "Cooler": "COOL_03_UA",
            "Case": "CASE_12_HU",
...
def _(builds, mo):
    build_choice = mo.ui.dropdown(
        ...
        value="Ukraine-first core + HU case",
        label="",
        full_width=True,
    )
            ...
            mo.Html(
                ...
                <div class="pc-wrap pc-select-block" style="margin-top: 0; margin-bottom: 8px;">
                  <div class="pc-control-shell">
                    ...
                    <div class="pc-section-subtitle">Start with the Ukraine-first basket, then swap any source or part below.</div>
                """
            ),
            build_choice,
            mo.Html(
